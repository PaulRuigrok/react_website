        ...
        <div className = 'w-full h-auto bg-white flex flex-col justify-center items-center'> 
            <div className= 'w-10/12 h-auto bg-blue-100 pl-20 flex pt-8 justify-left items-center motion-safe:animate-fadeIn'>
                <div className = 'flex flex-col w-1/2'>    
                    <h1 className= 'p10 text-9xl font-display text-gray-800 font-bold '>Crypto <br></br> Currencies</h1>
                    <p className= 'font-mono text-3xl text-gray-800 m-8 p10'>The hype around crypto's is back. Largely because of the proftis that
