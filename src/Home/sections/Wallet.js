...
const Wallet = () => {
    ...
    <>
    <div id='wallet'></div>
    <div className= 'w-10/12 h-full flex justify-center items-center mt-20 p-8 justify between'>
        <div className = 'flex flex-row items-center '>    
            <div className='w-1/2'>
                <h1 className= 'p10 text-6xl font-display text-gray-800 font-bold text-left'>Wallets:</h1>
                <p className= 'font-mono text-2xl text-gray-800 m-8 p10'>Okay, we got an Excel sheet that contains addresses and balances.<br></br><br></br>
                ...
                The solution?</p>
            <ArrowDown className='w-20 ml-60 animate-smallbounce'/>
            </div>
            <div className=' w-1/2 flex flex-col justify-center items-center '>
                <div className=' w-4/5 flex flex-col justify-center py-20 rounded-md border border-gray-200
                shadow-md  bg-gray-100'>
                    
                    <div className='flex justify-center'>
                        <div className='z-30 text-center'><WalletSvg className=' w-60'/></div>
                    </div>
                    
                    <div className='flex justify-center'>
                        <p className='text-2xl font-mono font-bold w-1/2'>Important note: When you create a wallet/address on a blockchain there will by created a key (called a 'private key') with it. You need the key for every outgoing transaction from your wallet.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className= 'z-0 w-10/12 h-auto flex flex-row justify-center items-start mt-20 p-8 justify-between bg-gray-100 rounded-md mt-80'>
            <div className ='sticky top-40'>
                    <h1 className= 'justify-self-start p20 text-6xl font-display text-gray-800 font-bold text-left'>Wallets Managers:</h1>    
            </div>
            <div className=''>
                <p className= 'font-mono text-2xl text-gray-800 m-8 p10'>
                    ...
                    <span className='font-mono font-thin italic'>E9873D79C6D87DC0FB6A5778633389F4453213303DA61F20BD67FC233AA33262</span>
                    <br></br><br></br>
                    ...
                    <br></br><br></br>
                    <div className='flex flex-row justify-around items-center my-8 '>
                        <div className='w-2/6'>
                            <img src={metamaskWallet} alt='Iconex_wallet' className='rounded-md shadow-2xl'/>
                            <p className= 'font-mono text-2xl text-gray-800 mt-8 p-4 italic'> This is MetaMask.
                        ...
                        <div className='w-2/6'>
                            <img src={iconexWallet} alt='Iconex_wallet' className='rounded-md shadow-2xl'/>
                            <p className= 'font-mono text-2xl text-gray-800 mt-8 p-4 italic'>This is the Iconex app.
