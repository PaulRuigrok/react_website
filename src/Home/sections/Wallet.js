...
const Wallet = () => {
    ...
    <div className= 'md:w-10/12 flex md:flew-col flex-row justify-center items-center mt-20 p-8 justify-between'>
        <div className = 'flex flex-col md:flex-row items-center'>    
            <div className='md:w-1/2 overflow-hidden'>
                <h1 className= 'text-6xl font-display text-gray-800 font-bold text-left'>Wallets:</h1>
                <p className= 'font-mono text-2xl text-gray-800 m-8'>Okay, we got an Excel sheet that contains addresses and balances.<br></br><br></br>
            ...
            <div className='md:w-1/2 flex flex-col justify-center items-center'>
                <div className='md:w-4/5 flex flex-col justify-center md:py-20 rounded-md border border-gray-200 shadow-md bg-gray-100'>
                    ...
                    <div className='flex justify-center'>
                        <p className='text-2xl font-mono font-bold p-6 md:w-1/2'>Important note: When you create a wallet/address on a blockchain there will by created a key (called a 'private key') with it. You need the key for every outgoing transaction from your wallet.</p>
                    </div>
                </div>
            </div>
        </div>   
    ...
    <div className= 'w-10/12 flex flex-col md:flex-row justify-center md:items-start p-8 bg-gray-100 rounded-md md:mt-80'>
        <div className ='md:sticky top-40'>
            <h1 className= 'text-6xl font-display text-gray-800 font-bold text-left'>Wallets Managers:</h1>    
        </div>
        <div>
            <p className= 'font-mono text-2xl text-gray-800 m-8'>
