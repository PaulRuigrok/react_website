...
const Wallet = () => {
    ...
    <>
        ...
        <div className= 'md:w-10/12 grid mt-20 p-4 md:p-8'>
            <div className = 'flex flex-col md:flex-row items-center'>    
                <div className='md:w-1/2'>
                    ...
                    <span className='bg-blue-100 p-2 italic'>! -> public key = the address of a wallet</span><br></br><br></br>
                    ...
                    <br></br><br></br>
                    Okay! So:<br></br><br></br>
                    <span className='bg-blue-100 p-2 italic'>! -> a wallet = a balance and a [ public key * private key ] -pair</span>
                    </p>
            ...
            <div>
                ...
                <div className='flex flex-col md:flex-row justify-around items-center my-8 md:mt-10 '>
                    <div className='md:w-2/6'>
                        ...
                        <p className= 'font-mono text-gray-400 font-thin md:mt-8 mb-20 p-4 italic'> MetaMask:
                    ...
                    <div className='md:w-2/6'>
                        ...
                        <p className= 'font-mono text-gray-400 font-thin md:mt-8 p-4 italic '>Iconex: 
        ...
        <div className='w-11/12 md:w-5/12 grid gap-20 md:mt-20 md:mb-60'>
            <div className='my-40 mx-6 md:m-8 font-mono text-xl md:text-2xl text-gray-800'>
                <p>
                    Alright! So:<br></br><br></br>
                    <span className='bg-blue-100 p-2 italic'>! -> apps like MetaMask are not really wallets but Wallet Managers</span>
                </p>
            </div>
        ...
        <div className=''>
            ...
            <div className='md:w-1/4 justify-self-end mt-8'>
