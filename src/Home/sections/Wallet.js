    ...
    <div className= 'md:w-10/12 flex md:flew-col flex-row justify-center items-center mt-20 p-4 md:p-8 justify-between'>
        <div className = 'flex flex-col md:flex-row items-center'>    
            <div className='md:w-1/2 overflow-hidden'>
                ...
                <p className= 'font-mono text-xl md:text-2xl text-gray-800 md:m-8'>Okay, we got an Excel sheet that contains addresses and balances.<br></br><br></br>
                ...
                <span className='font-mono font-light text-xs text-base leading-none italic'>* I like using the Icon Blockchain because the transactions are really fast and cheap. We'll be using Icon (the network/blockchain) and ICX (the native currency used on the Icon Blockchain) more in this tutorial. </span>
                <br></br><br></br>
