        ...
        <>
            ...
            <div className= 'w-10/12 h-full flex justify-center items-center mt-96'>
                <div  className = 'flex flex-col md:w-5/12'>    
                    <h1 className= 'p10 text-6xl md:text-8xl font-display text-gray-800 font-bold text-left'>My goal:</h1>
                    <p className= 'font-mono text-xl md:text-3xl text-gray-800 m-8 p10'>A lot of people won't even try to understand crypto's 
