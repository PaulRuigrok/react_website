        ...
        <div  className={`${inView ?'fade-in flex flex-col jusitfy-center' : 'fade-out flex flex-col jusitfy-center' } `}>
            ...
            <div className= 'w-11/12 md:w-10/12 flex justify-center p-6 items-center mt-48 md:mt-96'>
                <div ref={ref} className = {`flex flex-col md:w-5/12 `}>    
                    ...
                    <br></br><br></br>
                    Don't you think it's weird that you work your ass off week in week out, and then voluntary give the money you get for you labor to some guy in a suit?
                    <br></br><br></br>
                    ...
                    <br></br><br></br>
                    I made this website because I want show as much people as possible some of the practical basics of crypto. I even give you some free money in the end ;)
                    I thaught myself without any programming background so I'm sure you can too, if we take it step by step.<br></br><br></br>
