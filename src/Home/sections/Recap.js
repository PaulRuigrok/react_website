        ...
        <div className= 'w-10/12 flex flex-col justify-center items-center mt-20'>
            ...
            <div className='md:w-9/12 flex flex-col md:flex-row justify-around'>
                ...
                <div className='bg-white border shadow-lg p-4 m-2 md:p-8 md:m-4 rounded-md'>
                    ...
                    <p className= 'font-mono text-gray-800'>A blockchain is just a network of computers spread around the world, all sharing a copy of the same file / ledger / Excel sheet. Which contains addresses and balances.</p>
                </div>

                <div className='bg-white border shadow-lg p-4 m-2 md:p-8 md:m-4 rounded-md'>                    
                <h1 className='text-2xl md:text-4xl font-display font-bold mb-4'>Wallet</h1>
                    <p className= 'font-mono text-gray-800'>The term 'wallet' is used in a few different ways, but basically, a wallet is a different word for an address on a blockchain and consist of::<br></br> [public key * private key] - pair <br></br> and a balance.</p>
                </div>
                
                <div className='bg-white border shadow-lg p-4 m-2 md:p-8 md:m-4 rounded-md'>
                    <h1 className='text-2xl md:text-4xl font-display font-bold mb-4'>Wallet Managers</h1>
                    <p className= 'font-mono text-gray-800'>An app, or hardware device, that allows you to create wallets/addresses and send funds from your wallets without the need for any technical knowledge.<br></br>It makes talking to a blockchain easier for you.</p>
                </div>
